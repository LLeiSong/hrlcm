...
# Small learning scheduler, like zone125 and zone234.
# def get_compose_lr(model, epochs, min_lr=0.00001, max_lr=0.0001, stage1=10, stage2=40, stage3=70):
#     """Util function to customize a learning rate scheduler.
#     For 0.0001 - 0.00001
#     Note: not a perfect function, user could customize this function based on needs.
#         Args:
...
#         if i <= stage1:
#             if i == stage1:
#                 lr_scheduler_1 = torch.optim.lr_scheduler.CyclicLR(optimizer_lr, base_lr=0.00004,
#                                                                    max_lr=0.00008,
#                                                                    step_size_up=1, step_size_down=3,
#                                                                    gamma=0.9, cycle_momentum=False,
#                                                                    mode='exp_range')
...
#                                                                    max_lr=0.00004,
#                                                                    step_size_up=1, step_size_down=3,
#                                                                    gamma=0.92, cycle_momentum=False,
#                                                                    mode='exp_range')
#                 lr_scheduler_2.step()
#         elif stage2 < i <= stage3:
#             lr_scheduler_2.step()
