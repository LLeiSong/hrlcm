...
class ConfMatrix:
    """
    metrics utilized for evaluating multi-class(single-label) classification system
    """
    ...
    def calc(self, gt, pred):
        """ calcs and returns the CM without saving it to state """
...
def IoU(gt, pred, num_classes):
    ...
    get the intersection:
        that is the element [i,i] of the confusion matrix (cm)
    the union:
