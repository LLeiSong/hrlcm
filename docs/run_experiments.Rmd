...
Hum... Using a bigger weight for cropland in loss calculation increased the accuracy significantly.
...
Zone 1, 2, 3, 4, 5
```
python hrlcm/fit_compose_lr.py --exp_name unet_full_12bs_4augs_120epochs --num_workers 48 --gpu_devices '0,1,2,3' --min_lr 0.00001 --max_lr 0.001 --save_freq 20 --epochs 121
```
...
```
while true; do aws s3 cp --recursive $HOME/hrlcm/results/prediction s3://activemapper/leisong/prediction/zone1; sleep 50m; done
```

```
aws s3 cp --recursive s3://activemapper/leisong/unet_z1245_12bs_4augs_ft_80epochs/ $HOME/hrlcm/results/dl/unet_z1245_12bs_4augs_ft_80epochs
```