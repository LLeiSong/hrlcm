...
Within all groups, 1, 2, 4, 5/2, 3, 4, 5, and 1, 2, 5/2, 3, 4 update all weights. 1, 2/2, 5/2, 3/2, 4 update weights of last few layers.

Update all weights:

Zone 1, 2, 3, 4, 5
```
python hrlcm/fit_compose_lr.py --exp_name unet_full_12bs_4augs_ew_120epochs --num_workers 48 --gpu_devices '0,1,2,3' --min_lr 0.00001 --max_lr 0.001 --save_freq 20 --epochs 121
```

Then, comment out line 247 - 249 in `fit_compose_lr.py`, and modify `lr_scheduler.py` correspondingly. The learning rate scheduler is saved as a pickle as well.

Zone 1, 2, 4, 5
```
python hrlcm/fit_compose_lr.py --exp_name unet_z1245_12bs_4augs_ft_80epochs --num_workers 48 --gpu_devices '0,1,2,3' --min_lr 0.0000001 --max_lr 0.00001 --save_freq 20 --epochs 81 --resume 'results/dl/unet_full_12bs_4augs_120epochs/checkpoints/final.pth'
```

Zone 1, 2, 5
```
python hrlcm/fit_compose_lr.py --exp_name unet_z125_12bs_4augs_ft_80epochs --num_workers 48 --gpu_devices '0,1,2,3' --min_lr 0.0000001 --max_lr 0.00001 --save_freq 20 --epochs 81 --resume 'results/dl/unet_z1245_12bs_4augs_ft_80epochs/checkpoints/final.pth'
```

Zone 2, 3, 4, 5
```
python hrlcm/fit_compose_lr.py --exp_name unet_z2345_12bs_4augs_ft_80epochs --num_workers 48 --gpu_devices '0,1,2,3' --min_lr 0.0000001 --max_lr 0.00001 --save_freq 20 --epochs 81 --resume 'results/dl/unet_full_12bs_4augs_120epochs/checkpoints/final.pth'
```

Zone 2, 3, 4
```
python hrlcm/fit_compose_lr.py --exp_name unet_z234_12bs_4augs_ft_80epochs --num_workers 48 --gpu_devices '0,1,2,3' --min_lr 0.0000001 --max_lr 0.00001 --save_freq 20 --epochs 81 --resume 'results/dl/unet_z2345_12bs_4augs_ft_80epochs/checkpoints/final.pth'
```

Freeze some layers, only update weights of last few layers: 

1 * 8 (initial) + 4 * 8 (down) + 4 * 8 (up) + 2 = 74 layers

- 40: freeze all down layers
- 56: freeze all down and the first two up blocks (works the best)
- 64: freeze all down and the first three up blocks
- 72: freeze all down and up blocks, just update the last two layers

To ensure the class balance, we decided to use two zones together.

Zone 1, 2 (For zone 1)
```
python hrlcm/fit_compose_lr.py --exp_name unet_z12_12bs_4augs_ft_fz56_80epochs --num_workers 48 --gpu_devices '0,1,2,3' --min_lr 0.0000001 --max_lr 0.00001 --save_freq 20 --epochs 81 --resume 'results/dl/unet_z125_12bs_4augs_ft_80epochs/checkpoints/final.pth'
```

Zone 2, 5 (For zone 2 & 5)
```
python hrlcm/fit_compose_lr.py --exp_name unet_z25_12bs_4augs_ft_fz56_80epochs --num_workers 48 --gpu_devices '0,1,2,3' --min_lr 0.0000001 --max_lr 0.00001 --save_freq 20 --epochs 81 --resume 'results/dl/unet_z125_12bs_4augs_ft_80epochs/checkpoints/final.pth'
```
...
#### "Hierarchical" training with dynamic loss function

First, train a general model with relatively large learning rate (0.001 - 0.0001), balanced cross entropy loss function, and full training dataset for 80 epochs:

```
python hrlcm/fit_compose_lr.py --exp_name unet_full_12bs_4augs_80epochs --num_workers 48 --gpu_devices '0,1,2,3' --min_lr 0.0001 --max_lr 0.001 --save_freq 20 --epochs 81
```

Then, transfer with updating weights of all layers. It uses relatively small learning rate (0.0001 - 0.000001) with a dynamic loss that is a weighted average of BCE and Lovász-Softmax.

Take zone1 as an example:

```
python hrlcm/fit_compose_lr.py --exp_name unet_z1_12bs_4augs_ft_120epochs --num_workers 48 --gpu_devices '0,1,2,3' --min_lr 0.000001 --max_lr 0.0001 --save_freq 20 --epochs 121 --resume 'results/dl/unet_full_12bs_4augs_80epochs/checkpoints/final.pth'
```
...
For example:
```
python hrlcm/predict.py --args_path 'results/dl/unet_z12_12bs_4augs_ft_fz56_80epochs/checkpoints/args.pkl' --checkpoint_file 'results/dl/unet_z12_12bs_4augs_ft_fz56_80epochs/checkpoints/final.pth' --fname_predict 'dl_catalog_test.csv' --data_dir 'results/tanzania' --out_dir 'results/prediction_z12' --stats_dir 'results/tanzania/norm_stats' --num_workers 48 --batch_size 32 --gpu_devices '0,1,2,3'

scp -r ubuntu@ec2-3-88-131-12.compute-1.amazonaws.com:~/hrlcm/results/prediction_z12 /Users/pinot/Dropbox/research/hrlcm/results/tanzania/prediction/z12
```

Records:

```
python hrlcm/predict.py --args_path 'results/dl/unet_z12_12bs_4augs_ft_fz56_80epochs/checkpoints/args.pkl' --checkpoint_file 'results/dl/unet_z12_12bs_4augs_ft_fz56_80epochs/checkpoints/final.pth' --fname_predict 'dl_catalog_predict_zone1.csv' --data_dir 'results/tanzania' --out_dir 'results/prediction' --stats_dir 'results/tanzania/norm_stats' --num_workers 16 --batch_size 16 --gpu_devices '0'

python hrlcm/predict.py --args_path 'results/dl/unet_z25_12bs_4augs_ft_fz56_80epochs/checkpoints/args.pkl' --checkpoint_file 'results/dl/unet_z25_12bs_4augs_ft_fz56_80epochs/checkpoints/final.pth' --fname_predict 'dl_catalog_predict_zone2.csv' --data_dir 'results/tanzania' --out_dir 'results/prediction' --stats_dir 'results/tanzania/norm_stats' --num_workers 16 --batch_size 16 --gpu_devices '0'

python hrlcm/predict.py --args_path 'results/dl/unet_z25_12bs_4augs_ft_fz56_80epochs/checkpoints/args.pkl' --checkpoint_file 'results/dl/unet_z25_12bs_4augs_ft_fz56_80epochs/checkpoints/final.pth' --fname_predict 'dl_catalog_predict_zone5.csv' --data_dir 'results/tanzania' --out_dir 'results/prediction' --stats_dir 'results/tanzania/norm_stats' --num_workers 16 --batch_size 16 --gpu_devices '0'

python hrlcm/predict.py --args_path 'results/dl/unet_z23_12bs_4augs_ft_fz56_80epochs/checkpoints/args.pkl' --checkpoint_file 'results/dl/unet_z23_12bs_4augs_ft_fz56_80epochs/checkpoints/final.pth' --fname_predict 'dl_catalog_predict_zone3.csv' --data_dir 'results/tanzania' --out_dir 'results/prediction' --stats_dir 'results/tanzania/norm_stats' --num_workers 16 --batch_size 16 --gpu_devices '0'

python hrlcm/predict.py --args_path 'results/dl/unet_z24_12bs_4augs_ft_fz56_80epochs/checkpoints/args.pkl' --checkpoint_file 'results/dl/unet_z24_12bs_4augs_ft_fz56_80epochs/checkpoints/final.pth' --fname_predict 'dl_catalog_predict_zone4.csv' --data_dir 'results/tanzania' --out_dir 'results/prediction' --stats_dir 'results/tanzania/norm_stats' --num_workers 16 --batch_size 16 --gpu_devices '0'
```
...
### Copy files from/in S3

```
while true; do aws s3 cp --recursive $HOME/hrlcm/results/prediction_zone1 s3://activemapper/leisong/prediction/zone1_only; sleep 50m; done
```
