...
```
python hrlcm/fit_compose_lr.py --exp_name unet_no_weight_epoch400 --num_workers 32 --gpu_devices '0,1,2,3'
```
...
```
python hrlcm/predict.py --args_path 'results/dl/unet_no_weight_epoch400/checkpoints/args.pkl' --checkpoint_file 'results/dl/unet_no_weight_epoch400/checkpoints/interim.pth' --fname_predict 'dl_catalog_test.csv' --data_dir 'results/north' --out_dir 'results/prediction' --stats_dir 'results/north/norm_stats' --num_workers 32 --batch_size 32 --gpu_devices '0,1,2,3'
```
