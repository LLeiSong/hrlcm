...
scp -r /Users/pinot/Dropbox/research/hrlcm/results/north/norm_stats ubuntu@ec2-3-19-239-231.us-east-2.compute.amazonaws.com:~/hrlcm/results/north

scp /Users/pinot/Dropbox/research/hrlcm/results/north/dl_catalog_train.csv ubuntu@ec2-3-19-239-231.us-east-2.compute.amazonaws.com:~/hrlcm/results/north

scp /Users/pinot/Dropbox/research/hrlcm/results/north/dl_catalog_valid.csv ubuntu@ec2-3-19-239-231.us-east-2.compute.amazonaws.com:~/hrlcm/results/north
```

Run models:

```
python hrlcm/fit_compose_lr.py --exp_name unet_single_gl --lowest_score 9 --num_workers 32 --gpu_devices '0,1,2,3'
```

```
python hrlcm/fit_coteaching.py --exp_name unet_cot_gl_blind --lowest_score 9 --num_workers 32 --gpu_devices '0,1,2,3'
```

```
python hrlcm/fit_coteaching.py --exp_name unet_cot_8 --highest_score 8 --lowest_score 8 --num_workers 32 --gpu_devices '0,1,2,3'
```
...
```
python hrlcm/predict.py --args_path 'results/dl/args.pkl' --checkpoint_file 'results/dl/model2_final.pth' --fname_predict 'dl_catalog_predict.csv' --data_dir 'results/north' --out_dir 'results/prediction2' --stats_dir 'results/north/norm_stats' --num_workers 32 --batch_size 32 --gpu_devices '0,1,2,3'
```
...
```
python hrlcm/evaluate.py --args_path 'results/dl/args.pkl' --checkpoint_file 'results/dl/model1_final.pth' --data_dir 'results/north' --out_dir 'results/evaluation1' --stats_dir 'results/north/norm_stats' --num_workers 32 --batch_size 32 --gpu_devices '0,1,2,3'
```
...
- Deeplab3plus with ResNet as backbone. This architecture can consider the global context and have skip connections to ensure the complex structure still could get coverage.
