...
```
python hrlcm/fit_compose_lr.py --exp_name unet_k15_hard12_clr_rep_pad_220epc --quality_weight 1 --score_k 1.5 --hardiness_max 1.2 --num_workers 32 --gpu_devices '0,1,2,3' --epochs 201
```
