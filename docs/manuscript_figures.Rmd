...
ggsave(here('docs/figures/satellite_images.tiff'),
       fg, bg = "white", 
       width = 6, height = 6, dpi = 600)

# Figure 2, combination art
# Double column figure, 3740 * 3740 at 500 dpi
ggsave(here('docs/figures/figure2_satellite_images.tiff'),
       main_fg, bg = "white", units = "px", 
       width = 3740, height = 3740)
```
...
sub_tiling_fg <- ggplot(sub_tiling) + 
    ...
    geom_sf_text(aes(label = index), size = 3) +
    theme_void() +
    theme(legend.position = 'bottom',
...
ggsave(here('docs/figures/labels.tiff'),
       labels_fg, bg = "white",
